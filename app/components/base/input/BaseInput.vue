  ...
  <div>
    ...
    <div class="relative">
      ...
      <input
        ...
        class="w-full rounded-xl bg-sb-surface-2 border px-3 py-2 md:px-4 md:py-2.5 text-sb-contrast ty-sb-p focus:outline-none focus:ring-2 focus:ring-sb-accent truncate"
        :class="{
