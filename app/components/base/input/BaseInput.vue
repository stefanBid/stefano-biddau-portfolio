...
<template>
  <div>
    ...
    <input
      ...
      class="w-full rounded-lg bg-sb-surface-2 border border-sb-border px-3 py-1.5 sm:px-4 sm:py-2 text-sb-contrast ty-sb-paragraph focus:outline-none focus:ring-2 focus:ring-sb-accent u-sb-soft-transition"
